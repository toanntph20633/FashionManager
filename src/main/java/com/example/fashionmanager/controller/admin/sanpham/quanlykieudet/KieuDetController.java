...
public class KieuDetController {
    ...
    public ResponseEntity<?> getList(
        ...
        return kieuDetService.getList(ListKieuDetRequest.builder()
                .tenKieuDet(tenKieuDet).page(page).size(size).build());
    }

    @PostMapping("/create")
    public ResponseEntity<?> create(@RequestBody CreateKieuDetRequest request){
        return kieuDetService.create(request);
    }

    @PutMapping("/update")
    public ResponseEntity<?> update(@RequestBody UpdateKieuDetRequest request){
